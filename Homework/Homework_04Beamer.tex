...
% TITLE PAGE DATA--------------------------
\title[Beamer]{Beamer slides funtime} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Mia Murphy} % Your name
...
\medskip
\textit{mia.murphy@uvm.edu} % Your email address
}
...
% \begin{figure}
   \includegraphics[width=1.0\linewidth]{Images/Petaurista_nobilis_1.jpg}
...
\end{alltt}
\begin{verbatim}
##  [1] 0.45604734 0.57375310 0.07267362 0.41787301 0.57891930 0.43897620
##  [7] 0.17271920 0.54757363 0.37656058 0.81730846
\end{verbatim}
\end{kframe}
\end{knitrout}
